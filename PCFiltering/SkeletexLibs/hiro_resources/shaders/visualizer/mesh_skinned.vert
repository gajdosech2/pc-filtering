...
/// UNIFORM BUFFERS
layout (std140, binding = BIND_CUSTOM_0) uniform BoneTransformBlock1 { mat4 bindmats[@BONECOUNT@]; };
layout (std140, binding = BIND_CUSTOM_1) uniform BoneTransformBlock2 { mat4 posemats[@BONECOUNT@]; };
...
void main () 
{
	mat4 eye_transform = MODELVIEW_MAT;
	if (use_instancing)
	{
		eye_transform = eye_transform * instance_matrices[gl_InstanceID] * preinstance_mat;
	}
