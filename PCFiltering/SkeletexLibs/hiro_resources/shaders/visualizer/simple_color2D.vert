...
/// UNIFORMS
layout (location = LOC_CUSTOM_0) uniform vec4 edges; 
layout (location = LOC_CUSTOM_1) uniform ivec4 rect;
layout (location = LOC_CUSTOM_2) uniform vec3 line_color;

layout (location = LOC_CUSTOM_3) uniform uint draw_grid;
